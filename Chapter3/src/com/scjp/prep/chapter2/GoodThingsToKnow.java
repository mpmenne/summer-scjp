package com.scjp.prep.chapter2;
 ...
 * *********************************************** TAPESTRY PROPRIETARY VER 2.0
 */
public class GoodThingsToKnow {

/**
    The Black List of variable keywords (these CANNOT be used with variables)
    abstract
    native
    synchronized

    The Black List of method keywords (these CANNOT be used with methods)
    transient
    volative
